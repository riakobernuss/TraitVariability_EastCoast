...
mtcars <- read.csv("data/mtcars.csv") #info about car mpg

carkey <- read.csv("data/carkey.csv") #key for which car is which by ID

names <- read.csv("data/mtcars_names.csv") #key for ages of people
