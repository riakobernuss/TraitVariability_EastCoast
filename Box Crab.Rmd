...
```{r spelling}
glf_reduced$SPEC_GLF <- str_replace_all(glf_reduced$SPEC_GLF, "FLAMME", "FLAMMEA")
```

Extract relavent data.
```{r extraction}
glf_boxcrab <- subset(glf_reduced, SPEC_GLF == "FLAMMEA")
...
boxcrab_table <- rbind(glf_boxcrab_red.dt, neus_boxcrab_red.dt, seus_boxcrab_red.dt)
```
