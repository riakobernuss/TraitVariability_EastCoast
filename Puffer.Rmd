...
```{r extraction}
scot_puffer <- subset(GSDET_CAT_INF_SPE_merge, SPEC.y == "SPHOEROIDES MACULATUS")
...
```{r reduce}
scot_puffer_red<- scot_puffer[, c("FLEN", "FSEX", "SDATE", "SLAT", "SLONG", "BOTTOM_TEMPERATURE", "SPEC.y", "COMM")]
...
neus_puffer_red <- neus_puffer[, c("CATCHSEX", "LAT", "LON", "EST_TOWDATE", "BOTTEMP", "LENGTH", "SCINAME", "COMNAME")]
```

Add and rename columns so they can bind.
```{r add and rename}
scot_puffer_red <- rename(scot_puffer_red, "LENGTH" = "FLEN", "SEX" = "FSEX", "TEMPERATURE" = "BOTTOM_TEMPERATURE", "LATITUDE" = "SLAT", "LONGITUDE" = "SLONG", "DATE" = "SDATE", "SCINAME" = "SPEC.y", "COMNAME" = "COMM")
...
neus_puffer_red <- rename(neus_puffer_red, "SEX" = "CATCHSEX", "LATITUDE" = "LAT", "LONGITUDE" = "LON", "DATE" = "EST_TOWDATE", "TEMPERATURE" = "BOTTEMP")
