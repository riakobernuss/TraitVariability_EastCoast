...
data.dir = "C:/<wherever you put the data>/RVSurvey_20190702"
...
#step 2: filter the data as desired (overwriting the loaded objects)
  ...
  GSXTYPE = GSXTYPE[GSXTYPE$XTYPE ==1,]                   #valid tows only
  GSSTRATUM = GSSTRATUM[GSSTRATUM$STRAT %in% c(470:495),] #4X strata
